...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/Parqueo_Co/style.css">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/registrate.php">Registrate</a>
              </li>
              <li class="nav-item">
        ...
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p id="conocenos" style="color: black;">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <h6 id="contactanos" class="text-uppercase fw-bold mb-4">Contactanos</h6>
